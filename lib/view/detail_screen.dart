...
import 'package:meme/view_model/detail_screen_view_model/edit_image.dart';
          ...
          child: SingleChildScrollView(
            child: Column(
              children: [
                ...
                Text(
                  'Captions: ${widget.meme.captions}',
                  style: Theme.of(context).textTheme.bodyMedium,
                ),
                SizedBox(height: 8.0.h),
                Text(
                  'Width: ${widget.meme.width}',
                  style: Theme.of(context).textTheme.bodyMedium,
                ),
                ...
                ElevatedButton(
                  ...
                  onPressed: () {
                    EditImage(meme: widget.meme, context: context).editImage();
                  },
                  child: Text(
                    "Edit & download",
                    style: TextStyle(
